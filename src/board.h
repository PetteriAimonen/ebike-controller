...
X(GPIOA,  4, SPI1_CS     , OUTPUT     , LOW , PUSHPULL ,  50M , FLOATING ,  0) \
X(GPIOA,  5, SPI1_SCK    , ALTERNATE  , LOW , PUSHPULL ,  50M , FLOATING ,  5) \
X(GPIOA,  6, SPI1_MISO   , ALTERNATE  , LOW , PUSHPULL ,  50M , FLOATING ,  5) \
X(GPIOA,  7, SPI1_MOSI   , ALTERNATE  , LOW , PUSHPULL ,  50M , FLOATING ,  5) \
...
X(GPIOA, 15, DC_CAL      , ANALOG     , LOW , PUSHPULL ,  50M , FLOATING ,  0)
...
X(GPIOB,  4, EN_GATE     , OUTPUT     , LOW , PUSHPULL ,  50M , FLOATING ,  0) \
...
X(GPIOB,  8, FAULT       , INPUT      , LOW , PUSHPULL ,  50M , FLOATING ,  0) \
...
#define GPIOC_PINS(X) \
X(GPIOC,  0, TEMP_MOTOR  , ANALOG     , LOW , PUSHPULL ,  50M , FLOATING ,  0) \
...
X(GPIOC,  9, EXT3        , OUTPUT     , LOW , PUSHPULL ,  50M , FLOATING ,  0) \
